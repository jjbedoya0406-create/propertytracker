...
const en = {
  ...
  "recurringExpense.sectionTitle": "Recurring expenses",
  "recurringExpense.emptyStateBody":
    "Set up bills that repeat, like HOA or pest control. The app will list them here and remind you 5 days before each one is due.",
  "recurringExpense.addButton": "+ Add recurring expense",
  "recurringExpense.pausedTag": "Paused",
  "recurringExpense.nextDateLabel": "next {date}",
  "recurringExpense.monthly": "Monthly",
  "recurringExpense.quarterly": "Quarterly",
  "recurringExpense.newTitle": "New recurring expense",
  "recurringExpense.editTitle": "Edit recurring expense",
  "recurringExpense.buildingSubtitle": "{building} · Building",
  "recurringExpense.nameLabel": "Name",
  "recurringExpense.amountLabel": "Amount",
  "recurringExpense.frequencyLabel": "Frequency",
  "recurringExpense.nextDueDateLabel": "Next due date",
  "recurringExpense.missingFieldsError": "Add {fields} to save.",
  "recurringExpense.addedToast": "{name} added",
  "recurringExpense.savedToast": "{name} saved",
  "recurringExpense.pausedNote":
    "This expense is paused. It won't show up as due until you resume it.",
  "recurringExpense.pauseButton": "Pause",
  "recurringExpense.resumeButton": "Resume",
  "recurringExpense.endButton": "End",
  "recurringExpense.endConfirmTitle": "End {name}?",
  "recurringExpense.endConfirmBody":
    "It will stop showing up as due. Expenses you already logged stay in your records.",
  "recurringExpense.pausedToast": "{name} paused",
  "recurringExpense.resumedToast": "{name} resumed · next due {date}",
  "recurringExpense.endedToast": "{name} ended",
  "recurringExpense.dueTitle": "Due",
  "recurringExpense.overdueTag": "Overdue",
  "recurringExpense.skipButton": "Skip",
  "recurringExpense.confirmButton": "Confirm",
  "recurringExpense.dueDateLabel": "due {date}",
  "recurringExpense.skippedToast": "{name} skipped",
  "recurringExpense.confirmSheetTitle": "Confirm {name}",
  "recurringExpense.datePaidLabel": "Date paid",
  "recurringExpense.receiptLabel": "Receipt (optional)",
  "recurringExpense.loggedToast": "{name} logged · {amount}",
...
const es: Record<TranslationKey, string> = {
  ...
  "recurringExpense.sectionTitle": "Gastos recurrentes",
  "recurringExpense.emptyStateBody":
    "Configura cuentas que se repiten, como la administración o el control de plagas. La app las mostrará aquí y te avisará 5 días antes de cada vencimiento.",
  "recurringExpense.addButton": "+ Agregar gasto recurrente",
  "recurringExpense.pausedTag": "Pausado",
  "recurringExpense.nextDateLabel": "próximo {date}",
  "recurringExpense.monthly": "Mensual",
  "recurringExpense.quarterly": "Trimestral",
  "recurringExpense.newTitle": "Nuevo gasto recurrente",
  "recurringExpense.editTitle": "Editar gasto recurrente",
  "recurringExpense.buildingSubtitle": "{building} · Edificio",
  "recurringExpense.nameLabel": "Nombre",
  "recurringExpense.amountLabel": "Monto",
  "recurringExpense.frequencyLabel": "Frecuencia",
  "recurringExpense.nextDueDateLabel": "Próximo vencimiento",
  "recurringExpense.missingFieldsError": "Agrega {fields} para guardar.",
  "recurringExpense.addedToast": "{name} agregado",
  "recurringExpense.savedToast": "{name} guardado",
  "recurringExpense.pausedNote":
    "Este gasto está pausado. No aparecerá como pendiente hasta que lo reanudes.",
  "recurringExpense.pauseButton": "Pausar",
  "recurringExpense.resumeButton": "Reanudar",
  "recurringExpense.endButton": "Finalizar",
  "recurringExpense.endConfirmTitle": "¿Finalizar {name}?",
  "recurringExpense.endConfirmBody":
  ...
  "recurringExpense.skipButton": "Omitir",
  "recurringExpense.confirmButton": "Confirmar",
  "recurringExpense.dueDateLabel": "vence {date}",
  "recurringExpense.skippedToast": "{name} omitido",
  "recurringExpense.confirmSheetTitle": "Confirmar {name}",
  "recurringExpense.datePaidLabel": "Fecha de pago",
  "recurringExpense.receiptLabel": "Recibo (opcional)",
  "recurringExpense.loggedToast": "{name} registrado · {amount}",
